...
exports.search = function(req, res) {
            ...
            case 'groupUsers':
                ...
                switch (criteria.groupCriteria) {
                    ...
                    case 'assignTo':
                        ...
                        break;
                    case 'fixedBy':
                        parsePathIndexItems(searchCriteria, '/fixedBy/username', 'string', '=', value);
                        break;
                    case 'shippedBy':
                        parsePathIndexItems(searchCriteria, '/shippedBy/username', 'string', '=', value);
                        break
                    case 'closedBy':
                        parsePathIndexItems(searchCriteria, '/closedBy/username', 'string', '=', value);
                        break;
                    default:
                        // do nothing
                }
    ...
    /*
                    .stream().on('data', function(document) {
                        ...
                        if(document.content) delete document.content.changeHistory
