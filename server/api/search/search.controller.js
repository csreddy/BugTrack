                   ...
                   // searchCriteria.push(q.parsedFrom(value));
                    searchCriteria.push(
                        ...
                        case 'submittedBy':
                            ...
                            ;break;
                        case 'createdAt':
                            log.info('yesterday: ', yesterday); orQuery = [];
                        ...
                        case 'range':
                            ...
                            break;
                        case 'groupUsers':
                            log.info('groupCriteria', criteria.groupCriteria); parsePathIndexItems(searchCriteria, '/' + criteria.groupCriteria + '/username', 'string', '=', value);
                             break;
